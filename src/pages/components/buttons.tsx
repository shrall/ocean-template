      ...
      <CardContent className='grid grid-cols-2 gap-x-2 gap-y-4'>
        ...
        <div className='space-y-2'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <Button variant='default' color='warning' disabled>
              Default
            </Button>
            <Button variant='default' color='warning' shape='rounded'>
              Default
            </Button>
            <Button variant='default' color='warning' size='icon'>
              <Plus />
            </Button>
            <Button variant='default' color='warning' size='icon' disabled>
              <Minus />
            </Button>
            <Button variant='default' color='warning'>
              <ChevronLeft className='mr-1' />
          ...
          <div className='flex items-center gap-2'>
            ...
            <Button variant='outline' color='warning' shape='rounded'>
              Outline
            </Button>
            <Button variant='outline' color='warning' size='icon'>
              <Plus />
            </Button>
            <Button variant='outline' color='warning' size='icon' disabled>
              <Minus />
            </Button>
            <Button variant='outline' color='warning'>
              <ChevronLeft className='mr-1' />
          ...
          <div className='flex items-center gap-2'>
            ...
            <Button variant='ghost' color='warning' shape='rounded'>
              Ghost
            </Button>
            <Button variant='ghost' color='warning' size='icon'>
              <Plus />
            </Button>
            <Button variant='ghost' color='warning' size='icon' disabled>
              <Minus />
            </Button>
            <Button variant='ghost' color='warning'>
              <ChevronLeft className='mr-1' />
          ...
          <div className='flex items-center gap-2'>
            ...
            <Button variant='link' color='warning' shape='rounded'>
              Link
            </Button>
            <Button variant='link' color='warning' size='icon'>
              <Plus />
            </Button>
            <Button variant='link' color='warning' size='icon' disabled>
              <Minus />
            </Button>
            <Button variant='link' color='warning'>
              <ChevronLeft className='mr-1' />
